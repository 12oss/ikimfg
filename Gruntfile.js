	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: '_gh_pages/dist/css/iki.css'
			},
			js: {
				options: {
					separator: ';',
				...
				dest: '_gh_pages/dist/js/iki.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/iki.css',
				dest: '_gh_pages/dist/css/min/iki.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/iki.js',
				dest: '_gh_pages/dist/js/min/iki.min.js'
			}
		},
		watch: {
			css: {
